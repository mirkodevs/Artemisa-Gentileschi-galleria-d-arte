...
//Textures
let texturePavimento = new THREE.TextureLoader().load("public/img/texture/floor.jpg");
...
scene.add(wallGroup);
//wall texture
const wallTexture = new THREE.TextureLoader().load("public/img/texture/wall.jpg");
